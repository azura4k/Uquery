<template>
    <div class="container" style="padding-top: 5%;">
        <h3 class="text-dark mb-1">Legal</h3>
        <div class="card shadow mb-3">
            <div class="card-header py-3">
                <p class="text-primary m-0 font-weight-bold">All Binding Agreements</p>
            </div>
            <div class="card-body">
                <b-tabs>
                    <b-tab class="tab" title="Terms and Conditions">
                        <h2><strong>Terms and Conditions</strong></h2>

                        <p>Welcome to Uquery!</p>

                        <p>These terms and conditions outline the rules and regulations for the use of Uquery's Website,
                            located at https://uquery.azura4k.com.</p>

                        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to
                            use
                            Uquery if you do not agree to take all of the terms and conditions stated on this page.</p>
                        ...
                        <p>The following terminology applies to these Terms and Conditions, Privacy Statement and
                            ...
                            stated
                            services, in accordance with and subject to, prevailing law of Netherlands. Any use of the
                            above
                        ...
                        <p>We employ the use of cookies. By accessing Uquery, you agreed to use cookies in agreement
                            with
                            the Uquery's Privacy Policy. </p>
                        ...
                        <p>Unless otherwise stated, Uquery and/or its licensors own the intellectual property rights for
                            all
                            material on Uquery. All intellectual property rights are reserved. You may access this from
                            Uquery for your own personal use subjected to restrictions set in these terms and
                            conditions.
                        </p>

                        <p>You must not:</p>
                        <ul>
                            <li>Republish material from Uquery</li>
                            <li>Sell, rent or sub-license material from Uquery</li>
                            <li>Reproduce, duplicate or copy material from Uquery</li>
                            <li>Redistribute content from Uquery</li>
                        </ul>
                        ...
                        <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                            information in certain areas of the website. Uquery does not filter, edit, publish or review
                            Comments prior to their presence on the website. Comments do not reflect the views and
                            opinions
                            of Uquery,its agents and/or affiliates. Comments reflect the views and opinions of the
                            person
                            who post their views and opinions. To the extent permitted by applicable laws, Uquery shall
                            not
                            be liable for the Comments or for any liability, damages or expenses caused and/or suffered
                            as a
                            result of any use of and/or posting of and/or appearance of the Comments on this website.
                        </p>

                        <p>Uquery reserves the right to monitor all Comments and to remove any Comments which can be
                        ...
                        <p>You hereby grant Uquery a non-exclusive license to use, reproduce, edit and authorize others
                            to
                        ...
                        <p>We will approve link requests from these organizations if we decide that: (a) the link would
                            ...
                            hyperlink compensates the absence of Uquery; and (d) the link is in the context of general
                        ...
                        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking
                            to
                            our website, you must inform us by sending an e-mail to Uquery. Please include your name,
                            your
                        ...
                        <p>No use of Uquery's logo or other artwork will be allowed for linking absent a trademark
                            license
                            agreement.</p>
                        ...
                        <p>We do not take liabilty for the actions of users with their accounts. Users also agree that
                            any
                            and all information posted to their account was willfully and consentfully. We urge that
                            users
                            do not post any sensetive information to their accounts in order to avoid exploitation. We
                            also
                            reserve the right to ban, temporarily or permanently, Users for any reason at any time or
                            place.
                            We wish for everyone to stay safe online. We also reserve the right to hand out User
                            Information
                            upon contact and request of any legal, policing, or government agency. By signing up,
                            signing
                            in, or using this service, the User agrees to these terms.</p>
                    ...
                    <b-tab class="tab" title="Privacy Policy">
                        <h1>Privacy Policy for Uquery</h1>

                        <p>At Uquery, accessible from https://uquery.azura4k.com, one of our main priorities is the
                            privacy
                            of our visitors. This Privacy Policy document contains types of information that is
                            collected
                            and recorded by Uquery and how we use it.</p>
                        ...
                        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                            website with regards to the information that they shared and/or collect in Uquery. This
                            policy
                        ...
                        <p>Uquery follows a standard procedure of using log files. These files log visitors when they
                            visit
                        ...
                        <p>Like any other website, Uquery uses 'cookies'. These cookies are used to store information
                        ...
                        <p>Google is one of a third-party vendor on our site. It also uses cookies, known as DART
                            cookies,
                            to serve ads to our site visitors based upon their visit to www.website.com and other sites
                            on
                            the internet. However, visitors may choose to decline the use of DART cookies by visiting
                            the
                        ...
                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                            Beacons
                            that are used in their respective advertisements and links that appear on Uquery, which are
                            sent
                        ...
                        <p>Note that Uquery has no access to or control over these cookies that are used by third-party
                            advertisers.</p>

                        <h2>Third Party Privacy Policies</h2>

                        <p>Uquery's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                            advising
                        ...
                        <p>Uquery does not knowingly collect any Personal Identifiable Information from children under
                            the
                    ...
                    <b-tab class="tab" title="Copyright">
                        <p>Uquery is a Copyright of Devin B (Azura4k), 2022.<br>All Rights Reserved.<br>The Xbox,
                            Playstation, Nintendo, Steam, Twitter, Facebook, Reddit, Discord, and all other logos,
                            references, and trademarks are property to their respective owners and must be respected as
                            such. Any and all use of them is for simple icons, and representation of linking. If there
                            is an
                            issue with the use of these logos, please email:&nbsp;<br>legal@azura4k.com</p>
                    </b-tab>
                </b-tabs>
            </div>
        </div>
